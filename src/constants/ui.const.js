export const UI = {// eslint-disable-line import/prefer-default-export
  en: {
    ...
    auth: {
      ...
      minCharsLengthText: '- a minimum of 6 characters in length',
  ...
  de: {
    ...
    auth: {
      ...
      showPasswordText: 'Passwort anzeigen',
      loginBtnText: 'Einloggen',
      signUpBtnText: 'Anmelden',
      minCharsLengthText: '- mindestens 6 Zeichen lang',
