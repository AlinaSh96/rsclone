...
export const jumpFromUp = (scene, element) => {
  ...
  element.y = -element.height - element.y;// eslint-disable-line no-param-reassign
  scene.tweens.add({
    targets: element,
    y: initialY,
    duration: APP_CONFIG.animationDuration,
...
export const jumpFromLeft = (scene, element) => {
  ...
  element.x = -element.width - element.x;// eslint-disable-line no-param-reassign
  scene.tweens.add({
    targets: element,
    x: initialX,
    duration: APP_CONFIG.animationDuration,
...
export const jumpFromRight = (scene, element) => {
  const initialX = element.x;
  element.x = scene.sys.canvas.width;// eslint-disable-line no-param-reassign
  scene.tweens.add({
    targets: element,
    x: initialX,
    duration: APP_CONFIG.animationDuration,
